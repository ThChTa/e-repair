        ...
        query.orderByChild("email").equalTo(emailFromAdmin).addListenerForSingleValueEvent(new ValueEventListener() {  //from specific email find type
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot itemSnapshot : dataSnapshot.getChildren()) {
                    ...
                    dataAdapter = new AdminDataAdapter(options, sendToDataAdapter1,emailFromAdmin, Publications.this); //show to RV the full name,  Publications.this is to show Toast MESSAGE to AdminDataAdapter
